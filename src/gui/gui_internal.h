...
std::string GetKeyRepeatSliderFormat(int value, int autoValueMs, bool useSystemDefaultLabel = false);
std::string GetKeyRepeatDelaySliderFormat(int value, int autoValueMs, bool useSystemDefaultLabel = false);
