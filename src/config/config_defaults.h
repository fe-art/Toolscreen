...
constexpr int CONFIG_MOUSE_MOVEMENT_POLLING_RATE = 1000;
constexpr int CONFIG_MOUSE_MOVEMENT_POLLING_RATE_INTERVAL = 50;
constexpr int CONFIG_MOUSE_MOVEMENT_POLLING_RATE_MAX = 4000;
